...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Astro Software, Grabber/Builder. Deleuxe Version")
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Astro Software Builder", image=self.logo_image,
        ...
        self.all_options = customtkinter.CTkLabel(self.builder_frame, text="Our Builder Options", font=customtkinter.CTkFont(size=35, weight="bold", family=self.font))
