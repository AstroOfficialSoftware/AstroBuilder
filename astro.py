...
def main(webhook: str):
    ...
    data = {
        "username": "Astro Zip File Creator",
        "avatar_url": "https://media.discordapp.net/attachments/1012111266401230848/1113439333135941743/Comp_1_2.gif"
    }
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Astro Software | Created By Cal."
                    },
                    "thumbnail": {
                        "url": "https://media.discordapp.net/attachments/1012111266401230848/1113439333135941743/Comp_1_2.gif"
                    }
                }
            ],
            "username": "Astro",
